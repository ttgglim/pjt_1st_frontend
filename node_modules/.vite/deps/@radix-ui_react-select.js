...
var $5e63c961fc1ce211$export$8c6ed5c666ac13603 = (0, import_react19.forwardRef)((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    const newChildren = childrenArray.map((child) => {
      if (child === slottable) {
        ...
        return (0, import_react19.isValidElement)(newElement) ? newElement.props.children : null;
      } else
        return child;
    });
    return (0, import_react19.createElement)($5e63c961fc1ce211$var$SlotClone3, _extends({}, slotProps, {
      ref: forwardedRef
    }), (0, import_react19.isValidElement)(newElement) ? (0, import_react19.cloneElement)(newElement, void 0, newChildren) : null);
  }
  return (0, import_react19.createElement)($5e63c961fc1ce211$var$SlotClone3, _extends({}, slotProps, {
    ref: forwardedRef
  }), children);
...
var $5e63c961fc1ce211$var$SlotClone3 = (0, import_react19.forwardRef)((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  if ((0, import_react19.isValidElement)(children))
    return (0, import_react19.cloneElement)(children, {
...
var $5e63c961fc1ce211$export$d9f1ccf0bdb05d453 = ({ children }) => {
  return (0, import_react19.createElement)(import_react19.Fragment, null, children);
};
function $5e63c961fc1ce211$var$isSlottable3(child) {
  return (0, import_react19.isValidElement)(child) && child.type === $5e63c961fc1ce211$export$d9f1ccf0bdb05d453;
}
...
var $cc7e05a45900e73f$export$c973a4b3cb86a03d = (0, import_react26.forwardRef)((props, forwardedRef) => {
  ...
  if (!context.open) {
    const frag = fragment;
    return frag ? (0, import_react_dom4.createPortal)((0, import_react26.createElement)($cc7e05a45900e73f$var$SelectContentProvider, {
      scope: props.__scopeSelect
